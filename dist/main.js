...
var isBuffer = __webpack_require__(341);
...
var utils = __webpack_require__(18);
var settle = __webpack_require__(344);
var buildURL = __webpack_require__(346);
var parseHeaders = __webpack_require__(347);
var isURLSameOrigin = __webpack_require__(348);
var createError = __webpack_require__(131);
var btoa = (typeof window !== 'undefined' && window.btoa && window.btoa.bind(window)) || __webpack_require__(349);
...
module.exports = function xhrAdapter(config) {
  return new Promise(function dispatchXhrRequest(resolve, reject) {
    ...
    if (utils.isStandardBrowserEnv()) {
      var cookies = __webpack_require__(350);
...
var enhanceError = __webpack_require__(345);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__js_render__ = __webpack_require__(337);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__css_main_scss__ = __webpack_require__(359);
...
button.addEventListener("click", function () {
    page = 1;
    Object(__WEBPACK_IMPORTED_MODULE_0__js_render__["a" /* pageRender */])(page);
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_polyfill__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_polyfill___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_polyfill__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__server_fetch__ = __webpack_require__(338);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__add_images__ = __webpack_require__(358);
var pageRender = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(page) {
    var API_KEY, searchingWord, showMore, picturesAmount, baseUrlForSearch, url, _ref2, data, links;

    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            API_KEY = '935ae0186dbace947f1a0fdf7d92b27c';
            searchingWord = document.querySelector("#keyword").value;
            showMore = document.querySelector("#showMore");
            picturesAmount = 10;
            baseUrlForSearch = 'https://api.flickr.com/services/rest/?sort=relevance&parse_tags=1&content_type=7&lang=en-US&method=flickr.photos.search&format=json&nojsoncallback=1&hermes=1&hermesClient=1&extras=can_comment%2Ccount_comments%2Ccount_faves%2Cdescription%2Cisfavorite%2Clicense%2Cmedia%2Cneeds_interstitial%2Cowner_name%2Cpath_alias%2Crealname%2Crotation%2Curl_c%2Curl_l%2Curl_m%2Curl_n%2Curl_q%2Curl_s%2Curl_sq%2Curl_t%2Curl_z';
            url = baseUrlForSearch + "&api_key=" + API_KEY + "&text=" + searchingWord + "&page=" + page + "&per_page=" + picturesAmount;
            _context.next = 8;
            return Object(__WEBPACK_IMPORTED_MODULE_1__server_fetch__["a" /* getDataFromServer */])(url, picturesAmount, searchingWord);
          ...
          case 8:
            ...
            if (data.length) {
              ...
              data.forEach(function (photo) {
                ...
                links.push({ url: url_m, title: title });
              });
            } else {
              console.log('No hits');
            ...
            Object(__WEBPACK_IMPORTED_MODULE_2__add_images__["a" /* createImages */])(links, page);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios__ = __webpack_require__(339);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_axios__);


var handlePromiseError = function handlePromiseError(error) {
    return console.log("Error: " + error);
};

var processApiResponse = function processApiResponse(_ref) {
    var response = _ref.response,
        successCode = _ref.successCode,
...
var getDataFromServer = function getDataFromServer(url) {
...
axios.CancelToken = __webpack_require__(356);
...
axios.spread = __webpack_require__(357);
